...
class DirectionServiceTest extends Specification {
    ...
    def "buildDirectionList - 결과값이 거리순으로 정렬이되는지 확인"(){
        given:
        ...
        when:
        // pharmacySearchService는 목객체이다.
        // 테스트용 DocumentDto 리턴해주려면 키워드 >> 를 사용하면 됨
    ...
    def "buildDirectionList - 정해진 반경 10km내에 검색이 되는 지 확인"(){
        given:
        pharmacyList.add(
                PharmacyDto.builder()
                        .id(3L)
